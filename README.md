...
- 🎨 **月下案台视觉**：中秋夜烘焙案台、木模具、桂花、月相与真实食材平铺组成主视觉，素材全部随ZIP本地打包。
...
- ↩️ **可回退的制作流程**：每个步骤都有上一步入口，返回不会丢失已选饼皮、馅料和操作状态。
...
assets/editorial.css    # 基础画报视觉与响应式布局
assets/atelier.css      # 月下案台视觉、夜间烘焙与返回导航
assets/atelier-hero.webp # 月下烘焙案台主视觉
assets/ingredients-flatlay.webp # 馅料、饼皮、木模具与案台道具平铺
assets/moon-phases.webp # 带月面纹理的月相素材
